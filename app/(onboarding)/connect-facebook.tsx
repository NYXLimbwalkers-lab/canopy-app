...
export default function ConnectFacebookStep() {
  ...
  const handleSave = async () => {
    ...
    if (!trimmed) { setError('Please enter your Ad Account ID.'); return; }
  ...
  return (
    <View style={styles.flex}>
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <Button label="Connect Facebook Ads →" onPress={handleConnect} size="lg" />
      ...
      <Modal visible={modal} transparent animationType="slide" onRequestClose={() => setModal(false)}>
        ...
        >
          <View style={styles.modalSheet}>
            ...
            <Text style={styles.modalTitle}>Connect Facebook Ads</Text>
